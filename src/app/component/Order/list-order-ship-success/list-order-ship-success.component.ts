...
@Component({
  ...
  templateUrl: './list-order-ship-success.component.html',
  styleUrls: ['./list-order-ship-success.component.css']
})
export class ListOrderShipSuccessComponent implements OnInit {
